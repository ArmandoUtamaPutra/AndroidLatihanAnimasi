...
class RocketAdapter (private  val context: Context,
                     private val items: List<RocketAnimationItem>)
    : RecyclerView.Adapter<RocketAdapter.RocketViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: RocketAdapter.RocketViewHolder, p1: Int) {
